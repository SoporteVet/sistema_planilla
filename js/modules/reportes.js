        ...
        const html = `
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="card hover:shadow-lg transition cursor-pointer" onclick="ReportesModule.constanciaSalarial()">
                        <div class="text-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800 mb-2">Constancia Salarial</h3>
                            <p class="text-sm text-gray-600">Generar constancias para empleados</p>
                        </div>
                    </div>
                </div>
            </div>
