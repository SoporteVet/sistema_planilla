...
class SistemaPlanillas {
    constructor() {
        ...
        this.jornadas = {
            ...
            mixta_acumulativa: {
                ...
                diasPorSemana: 5,
                diasLibres: 2,
                observacion: 'Trabaja 9h pero se pagan 8h. 5 días trabajo, 2 días libres'
            }
        };
    ...
    renderTablaAguinaldos(empleados, salariosMensuales) {
        ...
        const datosAguinaldos = empleadosFiltrados.map(empleado => {
            ...
            // Aguinaldo en Costa Rica = promedio mensual (total / 12 meses trabajados)
    ...
    calcularAguinaldo(empleadoId, fechaInicio, fechaFin) {
        ...
        // Aguinaldo en Costa Rica = 1 mes de salario (salario mensual completo)
        const aguinaldo = parseFloat(calculos.salarioBruto);
    ...
    guardarPlanillaEnHistorial() {
        ...
        this.ultimaPlanilla.forEach(item => {
            const registro = {
                ...
                aguinaldo: parseFloat(item.salarioBruto), // Aguinaldo = 1 mes de salario
    ...
    generarComprobantePago(empleadoId, periodo, fechaInicio, fechaFin, enviarPorCorreo = false, aplicarImpuestoRenta = false) {
        ...
        // Salario mensual de referencia: usar días laborales reales (22 días promedio)
        // No usar 30 días porque solo cuenta días laborables
    ...
    calcularHorasSegunJornada(jornada, diaSemana, horario) {
        ...
        if (jornada === 'mixta_acumulativa') {
            // Trabajan 9 horas pero se pagan 8 horas
            if (horario && horario.toLowerCase().includes(diaSemana.toLowerCase())) {
                const match = horario.match(new RegExp(diaSemana + '[^:]*:?\\s*(\\d+)', 'i'));
                if (match) {
                    const horasTrabajadas = parseInt(match[1]);
                    // Si trabajó 9 horas o más, se pagan 8 horas. Si trabajó menos, se pagan las horas trabajadas
            ...
            // Default: devolver horas PAGADAS (8), no trabajadas (9)
            return 8;
        }
